...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE anuncio_global SET anuncio_assunto=%s WHERE id=%s",
                       GetSQLValueString($_POST['Anuncio_Global'], "text"),
  ...
  <div id="content-wrap">
    ...
    <span id="loader" style="display:none"></span>
     <div id="msgholder"></div>
         <h1><img src="../images/user-lrg.png" alt="" />Editando anúncio global [<?php echo $row_logs['log_name']; ?>]</h1>
      ...
      <th class="left"><div align="center">
        ...
        <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
         <label>ID:
          ...
          <label>Anúncio:
            <input name="Anuncio_Global" type="text" id="Anuncio_Global" value="<?php echo $row_anuncio_global['anuncio_assunto']; ?>" width="800px " />
            </label>
