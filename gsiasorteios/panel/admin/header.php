...
<div id ="header">
  <div class="wrap">
    ...
    <div id="menu">
      <ul id="nav">
        <li><a href="javascript:void(0);" title="Anuncio" class="users">Not&iacute;cias</a>
          <ul>
             <li><a href="announce.php" title="Anuncio">Ver Todos</a></li>
             <li><a href="addannounce.php" title="Anuncio">Adicionar Not&iacute;cia</a></li>
